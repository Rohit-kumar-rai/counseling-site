      ...
      <div className="w-full max-w-[2000px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 3xl:px-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 xl:gap-16 mb-12">
          ...
          <div>
            <Link to="/" className="inline-flex items-center mb-6 group">
              ...
              <div>
                ...
                <p className="text-blue-300 text-sm -mt-1">Counseling</p>
              </div>
            </Link>
            
            <p className="text-gray-400 mb-6 max-w-sm">
              Empowering students and professionals to make informed decisions about their educational and career paths.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-white transition-colors duration-300">Book a Call</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services#admission" className="text-gray-400 hover:text-white transition-colors duration-300">Admission Counseling</Link>
              </li>
              <li>
                <Link to="/services#career" className="text-gray-400 hover:text-white transition-colors duration-300">Career Guidance</Link>
              </li>
              <li>
                <Link to="/services#resume" className="text-gray-400 hover:text-white transition-colors duration-300">Resume Building</Link>
              </li>
              <li>
                <Link to="/services#interview" className="text-gray-400 hover:text-white transition-colors duration-300">Interview Preparation</Link>
              </li>
              <li>
                <Link to="/services#test" className="text-gray-400 hover:text-white transition-colors duration-300">Test Preparation</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span className="text-gray-400">BIT Mesra, Ranchi<br />Jharkhand, India 835215</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">info@pribhaytech.com</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-gray-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-gray-400">+91 8789529215</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {currentYear} Career Counseling. All rights reserved.
          </p>
